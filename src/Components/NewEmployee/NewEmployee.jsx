...
function NewEmployee() {
  ...
  return (
    <div
      className={isEditing ? 'newEmployeeCard edit' : 'newEmployeeCard addNew'}
    >
      {isEditing ? (
        <>
          ...
          <div className='frame'>
            <img
              src={
                firstname && lastname
                  ? `https://robohash.org/${firstname}${lastname}.png?set=set5&size=175x175`
                  : `/src/assets/unknownEmployee.svg`
              }
              alt={
                firstname && lastname
                  ? `${firstname} ${lastname}`
